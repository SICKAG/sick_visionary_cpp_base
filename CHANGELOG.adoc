...
* prevent SIGPIPE on disconnected tcp socket
* clear stale reconnect state before reopen

=== Added

* add readULInt to ParameterReader
...
* Visionary-T Mini CX (V3S105-1AAAAAA) 4.0.0
* Visionary-S CX (V3S102-1AAAAAA and V3S102-1AABAAB) 6.5.2
